...
def calculate_psnr(save_path,
    ...
    real_path = os.path.join(save_path,       f'{image_name}_real.jpg')
    mask_path = os.path.join(save_path,       f'{image_name}_mask.png')
    harmonized_path = os.path.join(save_path, f'{image_name}_harmonized.jpg')
...
def calculate_mse(save_path, image_name):
    real_path = os.path.join(save_path,       f'{image_name}_real.jpg')
    mask_path = os.path.join(save_path,       f'{image_name}_mask.png')
    harmonized_path = os.path.join(save_path, f'{image_name}_harmonized.jpg')
    ...
    mse_score = mean_squared_error(harmonized_np, real_np)
...
def calculate_fmse(save_path, image_name): # img1, img2, mask
    real_path = os.path.join(save_path,       f'{image_name}_real.jpg')
    mask_path = os.path.join(save_path,       f'{image_name}_mask.png')
    harmonized_path = os.path.join(save_path, f'{image_name}_harmonized.jpg')
    ...
    fore_area = np.sum(mask_np)
    fmse_score = np.mean((harmonized_np * mask_np - real_np * mask_np) ** 2) * 256 * 256 / fore_area
    fmse_score = float(fmse_score)
