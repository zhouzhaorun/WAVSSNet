...
def paired_paths_from_harmony_folder_test(comp_path_list):
    paths = []
    for idx in range(len(comp_path_list)):
        item_list = comp_path_list[idx].split(',')

        comp_path  = item_list[0].strip()
        scan_class = item_list[1].strip()
...
def paired_paths_from_harmony_folder_ori(comp_path_list):
    paths = []
    for idx in range(len(comp_path_list)):
        comp_path = comp_path_list[idx]
        name_parts = comp_path.split('_')
        mask_path = comp_path.replace('composite_images', 'masks')
...
def paired_paths_from_harmony_folder_our(comp_path_list):
    paths = []
    for idx in range(len(comp_path_list)):
        comp_path = comp_path_list[idx][0]
        mask_path = comp_path.replace('composite_images', 'masks')
        mask_path = mask_path.replace('.jpg','.png')
        real_path = comp_path.replace('composite_images','real_images')
        paths.append(
            dict([('comp_path', comp_path),
                  ('mask_path', mask_path),
                  ('real_path', real_path),
                  ('scan_class', comp_path_list[idx][1])
                  ]))
